...
const char* ssid = "Galaxy M02s4322";   // Your Network SSID
const char* password = "diksha@2002";   // Your Network Password

WiFiClient client;

// ThingSpeak Configuration
unsigned long myChannelNumber = 2501041; // Your Channel Number (Without Brackets)
const char * myWriteAPIKey = "D5GDH438FDY0PRN7"; // Your Write API Key
...
void handleHeartRate() {
  ...
  String BPMvalSend = String(constrain(BPMval, 50, 120)); // Limiting BPM value between 50 and 120
  Serial.print("BPM : ");
...
void GetHeartRate() {
  ...
  if (currentMillisHR - previousMillisHR >= intervalHR) {
    ...
    BPMval = constrain(cntHB * 6, 50, 120); // Limiting BPM value between 50 and 120
    cntHB = 0;
